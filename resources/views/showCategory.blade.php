...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('insertProduct') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Product</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('insertCategory') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Category</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  @foreach($categories as $category)
                    <tr>
                        <td>{{$category->id}}</td>
                        <td>{{$category->name}}</td>
                        <td> <a href="{{ route('deleteCategory', ['id' => $category->id]) }}" class="btn btn-danger btn-sm" href="#">
        ...
        <td><a href="{{url('insertCategory')}}" class="btn-sm"><button type="button" class="btn btn-block btn-info">Add New Category</button></a></td>
              <!-- /.card-body -->
            </div>
            <p>
        </p>
