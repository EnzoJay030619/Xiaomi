...
<div class="container">
        ...
        <div class="col-md-6"><a href="{{ route('product.name', ['id' => $product->id]) }}"><img  src="{{ asset('images/') }}/{{$product->image}}" alt="" width="50%" class="img-fluid"></a> </div>
            <div class="col-md-6"  style="border: 1px solid #333">
            <form action="{{ route('add.to.cart') }}" method="post">
                           {{ csrf_field() }}
                     <h5 class="card-title"><h6>Name </h6>{{$product->name}}</h5>
