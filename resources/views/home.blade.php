			...
			<div class="wrap-main-slide">
				<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
					<div class="item-slide">
						<img src="{{asset('images/cover.jpg')}}" alt="" class="img-slide">
						<div class="slide-info slide-1">
						</div>
					</div>
					<div class="item-slide">
						<img src="{{asset('images/cover 2.jpg')}}" alt="" class="img-slide">
						<div class="slide-info slide-2">
						</div>
					</div>
					<div class="item-slide">
						<img src="{{asset('images/cover 4.jpg')}}" alt="" class="img-slide">
			...
			<div class="wrap-banner style-twin-default">
				<div class="banner-item">
					<a href="#" class="link-banner banner-effect-1">
						<figure><img src="{{asset('images/cover 4.jpg')}}" alt="" width="590" height="190"></figure>
					</a>
				</div>
				<div class="banner-item">
					<a href="#" class="link-banner banner-effect-1">
						<figure><img src="{{asset('images/cover 3.jpg')}}" alt="" width="580" height="200"></figure>
					</a>
				</div>
			</div>
			<!--Latest Products-->
			<div class="wrap-show-advance-info-box style-1">
				...
				<div class="wrap-top-banner">
					<a href="#" class="link-banner banner-effect-2">
						<figure><img src="{{asset('images/cover 5.jpg')}}" width="1170" height="240" alt=""></figure>
					</a>
				</div>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2020 Southern University College. All rights reserved</p>
					</div>
