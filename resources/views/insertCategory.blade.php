  ...
  <div class="content-wrapper">
    ...
    <form class="subform"  method="post" action="{{ route('addCategory') }}" enctype="multipart/form-data"> 
        @csrf <!-- very important if you didn't insert CSRF, it not allow submit the data-->
              ...
              <div class="card-body">
                <input name="ID" id="ID" class="form-control form-control-lg" type="text" placeholder="ID">
                <br>
                <input name="name" id="name" class="form-control" type="text" placeholder="Insert Name"><br>
